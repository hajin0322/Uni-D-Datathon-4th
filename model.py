...
class GDFN(nn.Module):
    def __init__(self, channels, expansion_factor, dropout_rate=0.1):
...
class Restormer(nn.Module):
    def __init__(self, num_blocks=[4, 6, 6, 8], num_heads=[1, 2, 4, 8], channels=[6, 12, 24, 48], num_refinement=4,
